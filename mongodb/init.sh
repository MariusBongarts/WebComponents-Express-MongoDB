...
mongo ${MONGO_INITDB_DATABASE} -u ${MONGO_USER} -p ${MONGO_PASSWORD} \
        --eval "db.users.insert({ _id : ObjectId('5e5b929053d4ca0024f3323c'), email : '${ADMIN_USER}', password : '${ADMIN_PASSWORD}', name: 'Admin', createdAt: '1604682205640', id: 'ce0dd335-afa3-485a-82a7-a11f564b706c'});"
